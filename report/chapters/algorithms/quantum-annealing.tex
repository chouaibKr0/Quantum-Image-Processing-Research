...
Quantum Annealing (QA) represents a computational paradigm designed to find global minima of objective functions by exploiting quantum fluctuations~\cite{kadowaki1998quantum}. Unlike classical optimization methods, QA leverages \textbf{quantum tunneling} to escape local minima by passing through energy barriers rather than climbing over them~\cite{mcgeoch2014adiabatic}.
