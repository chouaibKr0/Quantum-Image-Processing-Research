...
QuantumLOGISMOS extends the classical LOGISMOS (Layered Optimal Graph Image Segmentation of Multiple Objects and Surfaces) framework~\cite{li2004,li2006} by incorporating quantum optimization via the Quantum Approximate Optimization Algorithm (QAOA)~\cite{farhi2014}. This approach is particularly suited for medical image analysis where geometric constraints ensure anatomically realistic segmentations~\cite{le2023quantumlogismos}.
